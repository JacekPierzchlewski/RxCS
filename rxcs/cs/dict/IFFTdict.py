...
def main(dCSConf):
    ...
    # =================================================================
    mDict = _generateIFFTDict(dCSConf)
...
def _computeParam(dCSConf):
    ...
    # -----------------------------------------------------------------
    # Compute the time start and time end of the dictionary
...
# =================================================================
# ENGINE generate the dictionary
# =================================================================
def _generateIFFTDict(dCSConf):
    ...
    vF_neg.sort()
    vF = fDelta * np.concatenate( (vF_neg, vF_pos) )
    vF.shape = (vF.size, 1)

    # -----------------------------------------------------------------
    # Generate the Dictionary matrix
    d = (1j*2*np.pi)   # d coefficient
    mDict = np.e**np.dot(vF,(d*vT) )
