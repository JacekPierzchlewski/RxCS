...
all of the signals generated by the generator. |br|

The following tests are performed on the generated signals:

    - is the number of generated signals correct?

    - is the length (the number of samples) in signals correct?

    - is the number of tones in signals correct?
